...
export default function Review() {
  const testimonials = [
    ...
    { quote: "Trusted service from Stoneley’s yet again. Diagnostics carried out, followed by repairs. The difference when driving the car now is so very noticeable. Thank you for your quality service and care.", name: "Simon Gardner" },
